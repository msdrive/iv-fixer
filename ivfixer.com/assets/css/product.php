...
<!-- Mirrored from ivfixer.com/assets/css/product.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2020 18:31:48 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Infinity Ventures</title>
	<link rel="icon" href="http://ivfixer.com/assets/css/assets/img/favi.png" type="image" sizes="16x16">
    <link rel="stylesheet" href="http://ivfixer.com/assets/css/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://ivfixer.com/assets/css/assets/fonts/font-awesome.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Acme">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Amiko">
    <link rel="stylesheet" href="http://ivfixer.com/assets/css/assets/css/styles.css">
</head>
...
<nav class="navbar navbar-light  sticky-top bg-secondary">
    <div class="container-fluid"><a href="http://ivfixer.com/assets/css/index.php" class="navbar-brand"><img src="http://ivfixer.com/assets/css/assets/img/logo.png" class="img-fluid logo" href="#" /></a><img src="http://ivfixer.com/assets/css/assets/img/fixerlogo.png" class="img-fluid logo fixer-logo"><button data-toggle="collapse" data-target="#navcol-1" class="navbar-toggler"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div
            class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav ml-auto">
                <li role="presentation" class="nav-item"><a href="http://ivfixer.com/assets/css/index.php" class="nav-link active">Home</a></li>
                <li role="presentation" class="nav-item"><a href="http://ivfixer.com/assets/css/services.php" class="nav-link ">Services</a></li>
                <li role="presentation" class="nav-item"><a href="http://ivfixer.com/assets/css/product.php" class="nav-link ">Product</a></li>
                <li role="presentation" class="nav-item"><a href="http://ivfixer.com/assets/css/about.php" class="nav-link ">About us</a></li>
                <li role="presentation" class="nav-item"><a href="http://ivfixer.com/assets/css/blog.php" class="nav-link ">Blog</a></li>
                <li role="presentation" class="nav-item"><a href="http://ivfixer.com/assets/css/contact.php" class="nav-link ">Contact us</a></li>
            </ul>
    </div>
    </div>
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <div class="jumbotron hero-nature carousel-hero"><img src="http://ivfixer.com/assets/css/assets/img/fixer.png" class="fixer">
                    <p class="hero-subtitle">A One Stop Shop For All Your UPVC hardware Need&nbsp; &nbsp; &nbsp;<br></p>
                    <p><a class="btn btn-primary btn-lg hero-button" role="button" href="http://ivfixer.com/assets/css/about.php">Learn more</a></p>
                </div>
            </div>
            <div class="carousel-item">
                <div class="jumbotron hero-photography carousel-hero"><img src="http://ivfixer.com/assets/css/assets/img/fixer.png" class="fixer"><p class="hero-subtitle">A One Stop Shop For All Your UPVC hardware Need&nbsp; &nbsp; &nbsp;<br></p>
                    <p><a class="btn btn-primary btn-lg hero-button" role="button" href="http://ivfixer.com/assets/css/about.php">Learn more</a></p>
                </div>
            </div>
            <div class="carousel-item">
                <div class="jumbotron hero-technology carousel-hero"><img src="http://ivfixer.com/assets/css/assets/img/fixer.png" class="fixer"><p class="hero-subtitle">A One Stop Shop For All Your UPVC hardware Need&nbsp; &nbsp; &nbsp;<br></p>
                    <p><a class="btn btn-primary btn-lg hero-button" role="button" href="http://ivfixer.com/assets/css/about.php">Learn more</a></p>
                </div>
            </div>
        </div>
    ...
    <section id="service" class="sect_pad">
        <div class="container">
            <div class="row">
               
                <div class="col">
                    <h4 class="text-uppercase text-center">Our Commitment</h4>
                    <div class="centr"></div>
            ...
            <div class="row serv2">
                <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    <div class="serv"><i class="fa fa-heart"></i>
                        <h5>Choiceness</h5>
                        <p>Varied Range&nbsp;<br></p>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                    <div class="serv"><i class="fa fa-arrows-alt"></i>
                        <h5>Satisfactory</h5>
                        <p>Suits every need of the customer&nbsp;<br></p>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 cntr">
                    <div class="serv"><i class="fa fa-bookmark"></i>
                        <h5>High Grade</h5>
                        <p>Superior Quality&nbsp;<br></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="product">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h4 class="text-uppercase text-center">Our Products</h4>
                    <div class="centr"></div>
                    <section>
                        <div class="container">
                            ...
                            <div class="row filtr-container">
                                    ...
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/c11.jpg">
                                        <div class="overlay">
                                    ...
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/s1.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form36">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="56">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/p31.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form38">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="56">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/p51.jpg">
                                        <div class="overlay">
                                    ...
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/csk1.png">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form40">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="57">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/selftapping1.png">
                                        <div class="overlay">
                                    ...
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d11.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form42">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="59">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d21.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form43">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="59">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d31.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form44">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="59">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d41.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form45">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="59">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d61.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form47">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="59">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d71.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form48">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="59">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d81.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form49">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="59">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/flat-packer1.jpg">
                                        <div class="overlay">
                                    ...
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/e11.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form50">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/f11.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form51">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/g11.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form52">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/h11.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form53">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/i11.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form54">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/j11.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form55">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/k11.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form56">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/popup-1.jpeg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form73">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/ROLLER-1.png">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form74">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/L-bracket-1.jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form76">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="60">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/11.jpg">
                                        <div class="overlay">
                                    ...
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/l11.jpg">
                                        <div class="overlay">
                                    ...
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/thermoplastic-elastomer-gaskets-500x500 (1).jpg">
                                        <div class="overlay">
                                            ...
                                            <div><a href="#" class="info" data-toggle="modal" data-target="#enquiry-form62">Enquiry</a></div>
								                                ...
								                                <div class="col-sm-6 col-md-4 col-lg-3 filtr-item" data-category="62">
                                    <div class="hovereffect"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/epdm1.jpg">
                                        <div class="overlay">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=35&amp;page=index">
                                                ...
                                                <div class="form-row enq-form">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6"><input class="form-control" type="tel" required="" name="cnumber" id="cnumber"></div>
                                                </div>
                                                <div class="form-row enq-form">
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more35">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/c11.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Nylon Frame Fixing Anchor</h4>
																																<span class="post">&nbsp;Brand: Fixer</span>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Nylon Frame Fixing Anchor are pre-assembled through fixing, a light duty nail expanding for solid masonry and hollow wall constructions. The design of the expansion nail used in the Nylon Frame Fixing Anchor is such that it can be removed if need be....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=35" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=36&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more36">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=36" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=38&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more38">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=38" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=39&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more39">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/p51.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Pan Head Phillips Self Drilling Screw - SS</h4>
																																<span class="post">&nbsp;Brand: Fixer</span>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Pan Head Phillips Self Drilling Screw are easy to install and designed to drill, tap and seal. ...</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=39" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=40&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more40">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/csk1.png">
                                                            <div class="box-heading py-2">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=40" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=82&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more82">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/selftapping1.png">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Pan Head Self Tapping Screw</h4>
																																<span class="post">&nbsp;Brand: Fixer</span>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Pan Head Self Tapping Screw is a screw that can tap its own hole as it is driven into the material. For hard substrates such as metal or hard plastics, the self-tapping ability is often created by cutting a gap in the continuity of the thread on the screw, generating a flute and cutting edge similar to those on a tap. These screws are manufactured to meet all recognised industry standards and performance criteria. A variety of sizes for any job large or small as well as larger pack sizes for those bigger projects....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=82" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=42&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more42">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d11.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Drain Hole Cover</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used to allow the water to drain out from within the frame, Snaps into pre-existing slots. This prevents bugs, debris and air from entering....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=42" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=43&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more43">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d21.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Drilling Screw Cap</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used to cover the hole made to fix the frame fixing Anchor after Installation....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=43" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=44&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more44">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d31.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Dust Arrester</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in UPVC Doors and windows, made of High quality Virgin Plastic...</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=44" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=45&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more45">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d41.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Fixed Louver</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in UPVC ventilators made of high quality virgin plastic designed to hold the glass at an inclined angle to admit light and air....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=45" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=47&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more47">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d61.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Plastic Jump Arrester</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in assembly of UPVC doors and window, made of high quality virgin plastic....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=47" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=48&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more48">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d71.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Plastic U-Packer</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Plastic U-Packers is used in Doors and Windows. It is resistant to weather changes and waterproof. Also used for partitions and door linings....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=48" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=49&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more49">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/d81.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Runner Block</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in the Assembly of UPVC Doors and windows, made of High quality virgin plastic....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=49" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=79&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more79">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/flat-packer1.jpg">
                                                            <div class="box-heading py-2">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=79" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=50&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more50">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/e11.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Adjustable Double Roller with Groove</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in assembly of UPVC sliding windows, our rollers are made of high quality material offering high performance and durability....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=50" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=51&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more51">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/f11.jpg">
                                                            <div class="box-heading py-2">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=51" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=52&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more52">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/g11.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Single Roller Flat</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in assembly of UPVC sliding doors, our rollers are made of high quality material offering high performance and durability....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=52" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=53&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more53">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/h11.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Casement Handle</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in UPVC openable window and doors,  our casement handles are meant for higher performance and durability....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=53" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=54&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more54">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/i11.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">Friction Hinges</h4>
																																<span class="post">&nbsp;Brand: Fixer</span>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in assembly of UPVC openable window. Our friction hinges are made of high quality stainless steel....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=54" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=55&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more55">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/j11.jpg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title"> Mesh Roller</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">Used in the assembly of bug screening for UPVC windows made of high quality material....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=55" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=56&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more56">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=56" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=73&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more73">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/popup-1.jpeg">
                                                            <div class="box-heading py-2">
                                                                <h4 class="title">POP UP Handle</h4>
																																</div>
                                                            <div class="boxContent">
                                                                <p class="text-center description">This handle is used in UPVC sliding windows/Doors, made of high quality material. Our handles are accredited for features like high strength, durability, light weight, heat and temperature resistance etc....</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=73" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=74&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more74">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/ROLLER-1.png">
                                                            <div class="box-heading py-2">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=74" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=76&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more76">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/L-bracket-1.jpg">
                                                            <div class="box-heading py-2">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=76" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=77&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more77">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="box"><img class="img-fluid" src="http://ivfixer.com/assets/css/upload/11.jpg">
                                                            <div class="box-heading py-2">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=77" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=57&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more57">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=57" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=62&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more62">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=62" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/product_mail.php?id=63&amp;page=index">
                                                <div class="form-row enq-form">
                                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 offset-sm-1 offset-md-1 offset-xl-1"><label class="col-form-label">Name</label></div>
                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-6 offset-md-0"><input class="form-control" type="text" required="" name="name" id="name"></div>
                                                </div>
                            ...
                            <div class="modal fade" role="dialog" tabindex="-1" id="know-more63">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer align-middle text-center boxContent"><a href="http://ivfixer.com/assets/css/p1.php?id=63" class="read">Read more<i class="fa fa-angle-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
    ...
    <section id="about" class="sect-padding">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-4 offset-lg-1 offset-xl-1 align-self-center"><img class="img-fluid" src="http://ivfixer.com/assets/css/assets/img/abt.jpg"></div>
                <div class="col-md-8 col-lg-6 col-xl-6">
                    <h4>About us</h4>
                    <p><br>Our Journey of Infinite Possibilities started in the year 2014. With cumulative experience and accumulated knowledge of more than 25 years in various spectrum of corporate and industrial world including  Aviation, Power, Wood working, Advertising, Industrial/Retail Storage Solutions, Automotive, Construction etc., we opened the Doors of Infinity Ventures dedicated to serve the UPVC world.<br><br><br><br></p>
...
Each and every product of FIXER is carefully crafted to last long. We take utmost care in providing highest degree of satisfaction to our customers. One of our most important principles is to achieve perfection in everything we do.</p>
                </div>
            </div>
        </div>
    </section>
	 <div class="customers">
        ...
        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="http://ivfixer.com/assets/css/img/spin.svg" />
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:150px;overflow:hidden;">
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/001.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/003.png" />
            </div>
      
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/005.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/007.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/008.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/009.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/010.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/011.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/012.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/013.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/014.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/015.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/016.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/017.png" />
            </div>
            <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/018.png" />
            </div>
             <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/019.png" />
            </div>
             <div data-p="43.75">
                <img data-u="image" src="http://ivfixer.com/assets/css/assets/img/021.png" />
            </div>
        </div>
        <!-- Bullet Navigator -->
        <div data-u="navigator" class="jssorb057" style="position:absolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
            <div data-u="prototype" class="i" style="width:16px;height:16px;">
                <svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:83%;height:58%;">
        ...
        <div data-u="arrowleft" class="jssora073" style="width:50px;height:50px;top:0px;left:30px;" data-autocenter="2" data-scale="0.75" data-scale-left="0.75">
            <svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:83%;height:83%;">
    ...
    <section id="blog" class="sect_pad">
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    <h4 class="text-uppercase text-center">Our Blog</h4>
                    <div class="centr"></div>
                </div>
            </div>
            <div class="row">
                               <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 offset-md-2 offset-lg-2 offset-xl-2">
                    <div class="box">
                        <div class="box-img"><img class="img-fluid blg_img" src="http://ivfixer.com/assets/css/upload/c11.jpg" alt="Williamson"></div>
                        <div class="box-content">
                            <h4 class="title">Nylon Frame Fixing Anchor</h4>
                            <p class="description">
															Nylon Frame Fixing Anchor are pre-assembled through fixing, a light duty nail expanding for solid masonry and hollow wall construc.....
								 								 <a  class="blog-btn" href="http://ivfixer.com/assets/css/p1.php?id=35">Read More</a>
							</p>
                        </div>
                    </div>
                </div>
						                  <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 offset-md-0 offset-lg-0 offset-xl-0">
                    <div class="box">
                        <div class="box-img"><img class="img-fluid blg_img" src="http://ivfixer.com/assets/css/upload/s1.jpg" alt="Williamson"></div>
                        <div class="box-content">
                            <h4 class="title">Countersunk Head Self Drilling Screw</h4>
                            <p class="description">
															Countersunk Head Self Drilling Screw enable drilling without first creating a pilot hole. These screws are usually used to join ma.....
								 								 <a  class="blog-btn" href="http://ivfixer.com/assets/css/p1.php?id=36">Read More</a>
							</p>
                        </div>
                    </div>
                </div>
   ...
   <section id="contact" class="sect_pad">
        <div class="container">
            ...
            <div>
				<form class="form-horizontal" method="post" action="http://ivfixer.com/assets/css/contact_mail.php">
                <div class="row">
    ...
    <div class="footer-bottom">
        ...
        <script src="http://ivfixer.com/assets/css/assets/js/jquery.min.js"></script>
    <script src="http://ivfixer.com/assets/css/assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="http://ivfixer.com/assets/css/assets/js/product-filter.js"></script>
    <script src="http://ivfixer.com/assets/css/assets/js/Animated-Number-element.js"></script>
	<script src="http://ivfixer.com/assets/css/assets/js/client-slider.js"></script>
	<script src="http://ivfixer.com/assets/css/assets/js/jssor.slider.js"></script>
</body>
